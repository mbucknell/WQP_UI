// Tooltips
const select = require("../../node_modules/uswds/src/js/utils/select");
const behavior = require("../../node_modules/uswds/src/js/utils/behavior");
const { prefix: PREFIX } = require("../../node_modules/uswds/src/js/config");
const isElementInViewport = require("../../node_modules/uswds/src/js/utils/is-in-viewport");
    ...
    init(root) {
      select(TOOLTIP, root).forEach((tooltipTrigger) => {
        ...
        if (tooltipContent) {
          ...
          addListenerMulti(tooltipTrigger, "onclick focus", () => {
          ...
          addListenerMulti(tooltipTrigger, "onclick blur keydown", () => {
